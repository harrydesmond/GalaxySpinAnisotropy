...
Also included is a program numpyro_spins_HSC.py for reproducing Stiskalek & Desmond 2024 (https://arxiv.org/abs/XXXX.XXXXX), assessing the significance of a dipole anisotropy in Hyper Suprime-Cam Data Release 3. This code uses NumPyro to sample with the No U-Turns Sampler, and the harmonic estimator to calculate evidences.
